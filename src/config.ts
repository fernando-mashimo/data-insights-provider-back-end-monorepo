class Config {
	...
	public static ESCAVADOR_ASYNC_UPDATE_MAX_TIME_WINDOW_DAYS: number = 7;
	public static ESCAVADOR_COMPANY_MONITORING_RECEIVED_DATA_WEBHOOK_AUTHORIZATION: string =
		'9gYvyjZ2o1AEMRa5D1moY2D6SHjN5K';

	public static BIG_DATA_CORP_API_URL: string = 'https://plataforma.bigdatacorp.com.br';
	public static BIG_DATA_CORP_API_ACCESS_TOKEN: string =
	...
	public static BIG_DATA_CORP_API_TOKEN_ID: string = '679274dcff4915d467b9ab55';
  public static BIG_DATA_CORP_EXTRACTION_MAX_TIME_WINDOW_DAYS: number = 30;
}
