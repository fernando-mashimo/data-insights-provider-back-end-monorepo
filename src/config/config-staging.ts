...
export class ConfigStaging implements Config {
	...
	public ESCAVADOR_COMPANY_MONITORING_RECEIVED_DATA_WEBHOOK_AUTHORIZATION: string =
		this.configProd.ESCAVADOR_COMPANY_MONITORING_RECEIVED_DATA_WEBHOOK_AUTHORIZATION;
